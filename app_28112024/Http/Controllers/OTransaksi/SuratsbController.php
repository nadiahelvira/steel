...
// ganti 2
class SuratsbController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        // ganti 3
        return view('otransaksi_suratsb.index')->with(['judul' => $this->judul, 'flagz' => $this->FLAGZ, 'golz' => $this->GOLZ ]);
    ...
    public function getSuratsb(Request $request)
    {
        // ganti 5
        ...
        return Datatables::of($surats)
            ...
            ->addColumn('action', function ($row) {
                if (Auth::user()->divisi=="programmer" ) 
				{
                    ...
                    $btnEdit =   ($row->POSTED == 1) ? ' onclick= "alert(\'Transaksi ' . $row->NO_BUKTI . ' sudah diposting!\')" href="#" ' : ' href="suratsb/edit/?idx=' . $row->NO_ID . '&tipx=edit&flagz=' . $row->FLAG . '&judul=' . $this->judul  . '&golz=' . $row->GOL  . '"';					
                    $btnDelete = ($row->POSTED == 1) ? ' onclick= "alert(\'Transaksi ' . $row->NO_BUKTI . ' sudah diposting!\')" href="#" ' : ' onclick="return confirm(&quot; Apakah anda yakin ingin hapus? &quot;)" href="suratsb/delete/' . $row->NO_ID . '/?flagz=' . $row->FLAG . '&golz=' . $row->GOL .'" ';
                    ...
                    $btnPrivilege =
                        '
                                ...
                                <a class="dropdown-item btn btn-danger" href="suratsb/cetak/' . $row->NO_ID . '">
...
//////////////////////////////////////////////////////////////////////////////////
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/suratsb/edit/?idx=' . $surats->NO_ID . '&tipx=edit&flagz=' . $this->FLAGZ . '&judul=' . $this->judul . '&golz=' . $this->GOLZ . '');
   ...
   public function edit( Request $request , Surats $surats)
    {
		...
		$data = [
         ...
         return view('otransaksi_suratsb.edit', $data)->with(['sup' => $sup])
  ...
  /**
    ...
    public function destroy(Request $request, Surats $surats)
    {
       ...
       return redirect('/suratsb?flagz='.$FLAGZ.'&golz='.$GOLZ)->with(['judul' => $judul, 'flagz' => $FLAGZ, 'golz' => $GOLZ ])->with('statusHapus', 'Data '.$surats->NO_BUKTI.' berhasil dihapus');
