	...
	<div class="content-wrapper">
		...
		<div class="content">
			...
			<div class="row">
				...
				<div class="card">
					<div class="card-body">
					    <form method="POST" action="{{url('jasper-nera-report')}}" >
					    @csrf
...
<!-- GANTI 2.1 -->
						...
						<button class="btn btn-danger" type="button" id="resetfilter" class="resetfilter" onclick="window.location='{{url("rnera")}}'">Reset</button>
