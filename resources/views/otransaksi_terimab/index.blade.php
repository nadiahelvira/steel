                ...
                <table class="table table-fixed table-striped table-border table-hover nowrap datatable" id="datatable">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th scope="col" style="text-align: center">No Muat</th>
                            ...
                            <th scope="col" style="text-align: center">Qty Beli</th>
                            <th scope="col" style="text-align: center">Qty Muat</th>
