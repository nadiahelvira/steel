                            ...
                            <form action="{{($tipx=='new')? url('/zsup/store/') : url('/zsup/update/'.$header->NO_ID ) }}" method="POST" name ="entri" id="entri" >
                                ...
                                <div class="mt-3 col-md-12 form-group row">
                                    <div class="col-md-4">
                                        ...
                                        <button type="button" id='PREVX' onclick="location.href='{{url('/zsup/edit/?idx='.$header->NO_ID.'&tipx=prev&buktix='.$header->NO_BUKTI )}}'" class="btn btn-outline-primary">Prev</button>
                                        <button type="button" id='NEXTX' onclick="location.href='{{url('/zsup/edit/?idx='.$header->NO_ID.'&tipx=next&buktix='.$header->NO_BUKTI )}}'" class="btn btn-outline-primary">Next</button>
