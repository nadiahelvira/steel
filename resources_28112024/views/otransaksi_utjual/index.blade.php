...
<script>
  $(document).ready(function() {
        ...
        //   dataTable.columns([5,7,8,10,11,12]).visible(true);
          
        // }
        // else
        // {
          
        //   dataTable.columns([5,7,8,10,11,12]).visible(false);
          
        // }



       $("div.test_btn").html('<a class="btn btn-lg btn-md btn-success" href="{{url('utjual/edit?flagz='.$flagz.'&idx=0&tipx=new')}}"> <i class="fas fa-plus fa-sm md-3" ></i></a>');
