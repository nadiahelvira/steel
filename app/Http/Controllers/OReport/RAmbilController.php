...
class RAmbilController extends Controller
{
  	...
  	public function report()
    {
        ...
        return view('oreport_ambil.report')->with(['kodec' => $kodec])->with(['cbg' => $cbg])->with(['hasil' => []]);
    }
	  

	public function jasperAmbilReport(Request $request) 
	{
		$file 	= 'ambiln';
		...
		if($request->has('filter'))
		{
			...
			return view('oreport_ambil.report')->with(['cbg' => $cbg])->with(['hasil' => $query]);
		}
